...
public class BackfillSope_Activity extends AppCompatActivity  {

    EditText lengthET, baseET, heightET, gradeET;
    Button clearBTN, calculateBTN;
    TextView resultTV;
    ImageView bacIMG, onIMG;
  ...
  /*  @Nullable
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_slope);
        ...
        onIMG = (ImageView) findViewById(R.id.onIMG);
        ...
        calculateBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double g = Double.parseDouble(gradeET.getText().toString());   //(LengthxBasexHeight)+base/2(HeightxBase)xgrade%=

                //Calculation
                double i = b/2*(h*b)*g;
                double output = (l*b*h)+i;
        ...
        Picasso.with(getApplicationContext()).load(R.drawable.ba).into(bacIMG);
        Picasso.with(getApplicationContext()).load(R.drawable.on).into(onIMG);
